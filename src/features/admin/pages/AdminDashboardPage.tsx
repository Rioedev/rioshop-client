...
export function AdminDashboardPage() {
  ...
  const quickActions = [
    { label: "Ðon hàng", icon: <ShoppingCartOutlined />, href: "/admin/orders" },
    { label: "S?n ph?m", icon: <AppstoreOutlined />, href: "/admin/products" },
    { label: "Mã gi?m giá", icon: <GiftOutlined />, href: "/admin/coupons" },
  ];
    ...
    <Spin spinning={loading}>
      ...
      <div className="space-y-5">
          ...
          <div className="relative flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="mb-2 text-xs font-bold uppercase tracking-[0.16em] text-slate-300">
                Trung tâm di?u ph?i RioShop
              </p>
              <Title level={3} className="mb-1! mt-0! text-white!">
                T?ng quan v?n hành hôm nay
              </Title>
              <Text className="text-slate-200!">
                S? li?u th?i gian th?c theo dõi doanh thu, don hàng, t?n kho và chuy?n d?i d? ra quy?t d?nh nhanh.
              </Text>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12} xl={4}>
            <Card className="h-full border-slate-200! shadow-sm!">
              <Text type="secondary">T? l? hoàn</Text>
          ...
          <Col xs={24} sm={12} xl={4}>
            <Card className="h-full border-slate-200! shadow-sm!">
              <Text type="secondary">Ðon ch? {'>'}24h</Text>
          ...
          <Col xs={24} sm={12} xl={4}>
            <Card className="h-full border-slate-200! shadow-sm!">
              <Text type="secondary">Khách m?i ({activeRangeLabel})</Text>
          ...
          <Col xs={24} sm={12} xl={4}>
            <Card className="h-full border-slate-200! shadow-sm!">
              <Text type="secondary">Khách quay l?i ({activeRangeLabel})</Text>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} xl={16}>
            <DashboardLineChartCard
              title={`Bi?u d? du?ng: Doanh thu theo ngày (${activeRangeLabel})`}
              subtitle="Theo dõi xu hu?ng doanh thu d? phát hi?n bi?n d?ng b?t thu?ng."
          ...
          <Col xs={24} xl={8}>
            <DashboardDonutCard
              title="Bi?u d? tròn: Co c?u tr?ng thái don"
              subtitle="Phân b? don theo tr?ng thái hi?n t?i"
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} xl={16}>
            <DashboardOrdersColumnCard
              title={`Bi?u d? c?t: Ðon hàng theo ngày (${activeRangeLabel})`}
              subtitle="14 ngày g?n nh?t: hoàn thành, ch? x? lý và h?y/hoàn"
              data={ordersColumnData}
            />
          </Col>
          <Col xs={24} xl={8}>
            <DashboardDonutCard
              title="Bi?u d? tròn: Co c?u phuong th?c thanh toán"
              subtitle="T? tr?ng don theo kênh thanh toán"
            ...
            <Card className="mb-4 border-slate-200! shadow-sm!">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="m-0 text-lg font-black text-slate-900">Tín hi?u th?i gian th?c</h3>
                </div>
                <ThunderboltOutlined className="text-xl text-cyan-600" />
              </div>
              <div className="mt-4 space-y-3">
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                  <p className="m-0 text-xs text-slate-500">Ðon hàng ch? duy?t</p>
                  <p className="m-0 mt-1 text-base font-bold text-slate-900">{pendingOrderCount} don</p>
                </div>
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                  <p className="m-0 text-xs text-slate-500">SKU s?p h?t hàng</p>
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                  <p className="m-0 text-xs text-slate-500">T? l? thêm gi? / xem s?n ph?m</p>
                  <p className="m-0 mt-1 text-base font-bold text-cyan-700">
                    {(dashboardMetrics?.conversion.addToCartRate ?? 0).toFixed(2)}%
                  </p>
                </div>
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                  <p className="m-0 text-xs text-slate-500">T? l? mua / thêm gi?</p>
