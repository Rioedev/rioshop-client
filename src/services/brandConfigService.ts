...
export type StorefrontHomeContent = {
  ...
  sections?: {
    ...
    categoryMosaicKicker?: string | null;
    showcaseKicker?: string | null;
    ...
    curatedKicker?: string | null;
    curatedTitle?: string | null;
    curatedDescription?: string | null;
    curatedLinkLabel?: string | null;
    collectionKicker?: string | null;
    collectionLinkLabel?: string | null;
    couponKicker?: string | null;
    couponTitle?: string | null;
    couponLinkLabel?: string | null;
  };
  labels?: {
    ...
    loadingHome?: string | null;
    heroPriceLabel?: string | null;
    heroSignalLabel?: string | null;
    heroSlideSecondaryLabel?: string | null;
    updatingLabel?: string | null;
    productOpenLabel?: string | null;
    shoppingCategoryLabel?: string | null;
    activeDealLabel?: string | null;
    sameDayFulfillmentLabel?: string | null;
    topCategoryBadgeLabel?: string | null;
    categoryDefaultBadge?: string | null;
    categoryBestSellerBadge?: string | null;
    categoryNewBadge?: string | null;
    categoryPromotionBadge?: string | null;
    soldUpdatedLabel?: string | null;
    couponSavedLabel?: string | null;
    couponSaveLabel?: string | null;
    couponAlreadySavedMessage?: string | null;
    couponSavedAndCopiedMessage?: string | null;
    couponSavedMessage?: string | null;
    viewCategoryLabel?: string | null;
  };
  ...
  member?: {
    ...
    loggedInDescription?: string | null;
    loggedInCtaLabel?: string | null;
  };
